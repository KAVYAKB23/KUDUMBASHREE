    ...
    return (
        <div> 
            ...
            <p className='notes'>Kudumbashree means different things to different people. For some, it is the poverty eradication project of the State government of Kerala. Some others view it as an exclusive domain of women engaged in social work. Yet in some others, the term Kudumbashree evokes the image of the women in uniform who come to collect waste from their door steps.
                ...
                If all of these is Kudumbashree, then, what is its history? How did it evolve? What we are trying to understand is how Kudumbashree – the community network of women and the Mission that supports it – came into being. Tracing it would amount to placing it in context, and examining the experiments and experiences from which the idea called Kudumbashree evolved.</p>
            <h3 className='heading'>EVOLUTION OF THE KUDUMBASHREE IDEA</h3>
            <p className='notes'>Set in the context of the People’s Plan Movement which was a state strategy for mass mobilisation for bottom-up planning in the wake of the decentralisation of powers, Kudumbashree has been an outcome of its specific context.
